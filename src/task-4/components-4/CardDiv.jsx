    ...
    useEffect(() => {
      async function fetchUsers() {
        ...
        const sortedData = data.sort(
          (a, b) => a.original_title.localeCompare(b.original_title, "ta-IN"),
        );
      ...
      <>
        ...
        <aside className="col-span-3 h-full py-8 space-y-7 px-8 border-r border-white/50">
          ...
          <div className="text-orange-500">
            {inputVal !== "" && <p>Movies are filtered by name : <span>{inputVal}</span></p>}
          </div>
        </aside>
        ...
        (<div className="text-red-500 text-center font-semibold items-center col-span-9 content-center">no data found</div>)}
      </>
    );
}
